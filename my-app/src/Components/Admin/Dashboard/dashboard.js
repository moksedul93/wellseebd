                    ...
                    <ul class="dropdown-menu right-aligned">
                      ...
                      <li>
                        <a href="#">
                          ...
                          This is fantastic<span class="badge-red">3</span>
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <img src="img/msg4.jpg" />
                          May i know the admin name?
                ...
                <div class="dropdown-btn-cover">
                  <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu right-aligned">
                      ...
                      <li>
                        <a href="#">
                          <i class="fa fa-circle-o"></i>Server Ready To Run
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-circle-o"></i>1 Admin Has been
                          Approved
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-circle-o"></i>100 Students Registered
                        </a>
                      </li>
                      <li>
                        <a href="#">
                          <i class="fa fa-circle-o"></i>Notice Has Been
                          Published
                        </a>
                      </li>
                    </ul>
            ...
            <div class="row">
              <div class="col-md-9">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="single-dashboard-menu-wrapper">
                      <a href="attendence-student.html">
                  ...
                  <div class="col-md-2">
                    <div class="single-dashboard-menu-wrapper">
                      <a href="attendence-employee.html">
                        <i class="fa fa-clock-o"></i>
                      </a>
                  ...
                  <div class="col-md-2">
                    <div class="single-dashboard-menu-wrapper">
                      <a href="attendence-teacher.html">
                        <i class="fa fa-clock-o"></i>
                      </a>
